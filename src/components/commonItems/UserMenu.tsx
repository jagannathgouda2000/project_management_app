        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56">
                <DropdownMenuGroup>
                    ...
                    <Link href={"/profile"}>
                        <DropdownMenuItem className={"focus:bg-brand-light focus:text-dark cursor-pointer rounded-full pl-4"}>
                            Profile
                        </DropdownMenuItem>
                    </Link>
                </DropdownMenuGroup>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem
                    className="cursor-pointer rounded-full pl-4 focus:bg-dark focus:text-dark"
